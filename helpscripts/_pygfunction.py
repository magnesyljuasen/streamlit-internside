...
class Simulation:
    ...
    def _properties(self):
        ...
        self.ALPHA = 2.2e-6  # Ground thermal diffusivity (m2/s)
    ...
    def _fluid_properties(self):
        ...
        self.CP_F = 3810  # Fluid specific isobaric heat capacity (J/kg.K)
        self.RHO_F = 1106  # Fluid density (kg/m3)
        self.MU_F = 0.0022870  # Fluid dynamic viscosity (kg/m.s)
        self.K_F = 0.4990  # Fluid thermal conductivity (W/m.K)
    ...
    def _plot_hourly_temperatures(self):
        ...
        st.write("Gjennomsnittlig temperatur")
        Plotting().xy_simulation_pygf_plot(hours, self.tf_mean, Plotting().FOREST_GREEN)
        ...
        st.write("Temperatur ut fra VP")
        Plotting().xy_simulation_pygf_plot(hours, self.tf_in, Plotting().FOREST_GREEN)
        st.write("Temperaturer inn fra VP")
        Plotting().xy_simulation_pygf_plot(hours, self.tf_out, Plotting().FOREST_GREEN)
